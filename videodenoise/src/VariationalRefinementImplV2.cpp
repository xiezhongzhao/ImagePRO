 ...
 */
    void VariationalRefinementImplV2::splitCheckerboard(RedBlackBuffer &dst, Mat &src)
    {
//        CV_INSTRUMENT_REGION();
 ...
 */
    void VariationalRefinementImplV2::mergeCheckerboard(Mat &dst, RedBlackBuffer &src)
    {
//        CV_INSTRUMENT_REGION();
 ...
 */
    void VariationalRefinementImplV2::updateRepeatedBorders(RedBlackBuffer &dst)
    {
//        CV_INSTRUMENT_REGION();
    ...
    VariationalRefinementImplV2::RedBlackBuffer::RedBlackBuffer()
    {
//        CV_INSTRUMENT_REGION();

        release();
    }
    void VariationalRefinementImplV2::RedBlackBuffer::create(Size s)
    {
//        CV_INSTRUMENT_REGION();
    ...
    void VariationalRefinementImplV2::RedBlackBuffer::release()
    {
//        CV_INSTRUMENT_REGION();
    ...
    VariationalRefinementImplV2::ParallelOp_ParBody::ParallelOp_ParBody(VariationalRefinementImplV2 &_var, vector<Op> _ops,
    ...
    void VariationalRefinementImplV2::ParallelOp_ParBody::operator()(const Range &range) const
    {
//        CV_INSTRUMENT_REGION();
    ...
    void VariationalRefinementImplV2::warpImage(Mat &dst, Mat &src, Mat &flow_u, Mat &flow_v)
    {
//        CV_INSTRUMENT_REGION();
    ...
    void VariationalRefinementImplV2::prepareBuffers(Mat &I0, Mat &I1, Mat &W_u, Mat &W_v)
    {
//        CV_INSTRUMENT_REGION();
        ...
        Mat averagedI;
        {
            ...
            vector<Op> ops;
            ops.push_back(&VariationalRefinementImplV2::averageOp);
            ops.push_back(&VariationalRefinementImplV2::subtractOp);
        ...
        /* Computing first-order derivatives */
        {
            ...
            vector<Op> ops;
            ops.push_back(&VariationalRefinementImplV2::gradHorizAndSplitOp);
            ops.push_back(&VariationalRefinementImplV2::gradVertAndSplitOp);
            ops.push_back(&VariationalRefinementImplV2::gradHorizAndSplitOp);
            ops.push_back(&VariationalRefinementImplV2::gradVertAndSplitOp);
    ...
    VariationalRefinementImplV2::ComputeDataTerm_ParBody::ComputeDataTerm_ParBody(VariationalRefinementImplV2 &_var,
 ...
 */
    void VariationalRefinementImplV2::ComputeDataTerm_ParBody::operator()(const Range &range) const
    {
//        CV_INSTRUMENT_REGION();
...
#undef INIT_ROW_POINTERS
    ...
    VariationalRefinementImplV2::ComputeSmoothnessTermHorPass_ParBody::ComputeSmoothnessTermHorPass_ParBody(
            VariationalRefinementImplV2 &_var, int _nstripes, int _h, RedBlackBuffer &_W_u, RedBlackBuffer &_W_v,
 ...
 */
    void VariationalRefinementImplV2::ComputeSmoothnessTermHorPass_ParBody::operator()(const Range &range) const
    {
//        CV_INSTRUMENT_REGION();
...
#undef UPDATE
    ...
    VariationalRefinementImplV2::ComputeSmoothnessTermVertPass_ParBody::ComputeSmoothnessTermVertPass_ParBody(
            VariationalRefinementImplV2 &_var, int _nstripes, int _h, RedBlackBuffer &_W_u, RedBlackBuffer &_W_v, bool _red_pass)
...
/* This function adds the last remaining terms to the linear system coefficients A11,A22,b1,b1. */
    void VariationalRefinementImplV2::ComputeSmoothnessTermVertPass_ParBody::operator()(const Range &range) const
    {
//        CV_INSTRUMENT_REGION();
...
#undef INIT_ROW_POINTERS
    ...
    VariationalRefinementImplV2::RedBlackSOR_ParBody::RedBlackSOR_ParBody(VariationalRefinementImplV2 &_var, int _nstripes,
 ...
 */
    void VariationalRefinementImplV2::RedBlackSOR_ParBody::operator()(const Range &range) const
    {
//        CV_INSTRUMENT_REGION();
...
#undef INIT_ROW_POINTERS
    ...
    void VariationalRefinementImplV2::calc(InputArray I0, InputArray I1, InputOutputArray flow)
    {
//        CV_INSTRUMENT_REGION();
    ...
    void VariationalRefinementImplV2::calcUV(InputArray I0, InputArray I1, InputOutputArray flow_u, InputOutputArray flow_v)
    {
//        CV_INSTRUMENT_REGION();
